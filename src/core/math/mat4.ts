...
export const M33 = 15
  ...
  export const clear = (src: Mat4): Mat4 => {
    src[M00] = 0;	src[M01] = 0;	src[M02] = 0;	src[M03] = 0;
		src[M10] = 0;	src[M11] = 0;	src[M12] = 0;	src[M13] = 0;
		src[M20] = 0;	src[M21] = 0;	src[M22] = 0;	src[M23] = 0;
    src[M30] = 0;	src[M31] = 0;	src[M32] = 0;	src[M33] = 0;
	...
	{
		des[M00] = 1;	des[M01] = 0;	des[M02] = 0;	des[M03] = 0;
		des[M10] = 0;	des[M11] = 1;	des[M12] = 0;	des[M13] = 0;
		des[M20] = 0;	des[M21] = 0;	des[M22] = 1;	des[M23] = 0;
		des[M30] = 0;	des[M31] = 0;	des[M32] = 0;	des[M33] = 1;
	...
	{
		des[M00] = 1;	des[M01] = 0;	des[M02] = 0;	des[M03] = x;
		des[M10] = 0;	des[M11] = 1;	des[M12] = 0;	des[M13] = y;
		des[M20] = 0;	des[M21] = 0;	des[M22] = 1;	des[M23] = z;
		des[M30] = 0;	des[M31] = 0;	des[M32] = 0;	des[M33] = 1;
    ...
    const m = des.values
		...
		m[M00] = x;	m[M01] = 0;	m[M02] = 0;	m[M03] = 0;
		m[M10] = 0;	m[M11] = y;	m[M12] = 0;	m[M13] = 0;
		m[M20] = 0;	m[M21] = 0;	m[M22] = z;	m[M23] = 0;
	...
	export const mul = (des: Mat4, a: Mat4, b: Mat4): Mat4 =>
  {
    ...
    let a00 = aV[M00], a01 = aV[M01], a02 = aV[M02], a03 = aV[M03];
    let a10 = aV[M10], a11 = aV[M11], a12 = aV[M12], a13 = aV[M13];
    let a20 = aV[M20], a21 = aV[M21], a22 = aV[M22], a23 = aV[M23];
    let a30 = aV[M30], a31 = aV[M31], a32 = aV[M32], a33 = aV[M33];
  
    // Cache only the current line of the second matrix
    let b0  = bV[0], b1 = bV[1], b2 = bV[2], b3 = bV[3];
    ...
    b0 = bV[4]; b1 = bV[5]; b2 = bV[6]; b3 = bV[7];
    ...
    b0 = bV[8]; b1 = bV[9]; b2 = bV[10]; b3 = bV[11];
    ...
    b0 = bV[12]; b1 = bV[13]; b2 = bV[14]; b3 = bV[15];
